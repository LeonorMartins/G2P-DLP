...
def apply_patterns_to_words(words_list, regex_dict, log_file_path="debug_log.txt"):
    processed_words = []
...
if __name__ == "__main__":
    file_path = "Palavras.ods"  # Replace with your ODS file path
    folha_palavras = "Palavras"  # Replace with the desired sheet name
    folha_expressoes = "ExpressoesConsoantes"
